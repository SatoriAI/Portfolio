...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'I transform ideas into stable and reliable systems. From backend logic to infrastructure solutions. My passion is creating products that connect technology with people.',
      askAI: 'Ask AI About Me'
    },
    about: {
      title: 'About Me',
      paragraph1: "I am someone who enjoys combining curiosity with creativity, both in my professional work and personal life. Beyond programming, I am passionate about teaching, exploring new ideas, and sharing knowledge in a way that inspires others. I am drawn to challenges that require analytical thinking as well as a touch of imagination — whether it’s solving complex mathematical problems or working on personal projects that allow me to learn and grow.",
  ...
  pl: {
    ...
    hero: {
      title: 'Backend Developer',
      subtitle: 'Zamieniam pomysły w stabilne i niezawodne systemy. Od logiki backendu po rozwiązania infrastrukturalne. Moją pasją jest tworzenie produktów, które łączą technologię z ludźmi.',
      askAI: 'Porozmawiaj o mnie z AI'
    },
    about: {
      title: 'O mnie',
      paragraph1: 'Jestem osobą, która lubi łączyć ciekawość z kreatywnością, zarówno w pracy, jak i w życiu prywatnym. Poza programowaniem pasjonuję się nauczaniem, odkrywaniem nowych pomysłów i dzieleniem się wiedzą w sposób, który inspiruje innych. Przyciągają mnie wyzwania wymagające analitycznego myślenia, ale i odrobiny wyobraźni — czy to przy rozwiązywaniu trudnych problemów matematycznych, czy nad osobistymi projektami, które pozwalają mi się rozwijać.',
      paragraph2: 'Specjalizuję się w budowaniu solidnych systemów backendowych i skalowalnych infrastruktur, głównie w Pythonie (Django, FastAPI, SQLAlchemy) oraz w nowoczesnych praktykach DevOps. Moja praca obejmuje projektowanie API, modelowanie danych, konfigurację pipeline’ów CI/CD i wdrożenia w chmurze. Cenię czysty kod, automatyzację i dokumentację, a szczególnie lubię działać na styku backendu, DevOps i aplikacji opartych na danych. Interesują mnie także najnowsze zagadnienia, takie jak LLM, systemy rozproszone czy kryptografia.',
      philosophy: 'Podejście techniczne',
      philosophyText: 'Podchodzę do technologii z przekonaniem, że czyste, skalowalne i przede wszystkim łatwe w utrzymaniu rozwiązania stanowią fundament trwałych systemów. Kod traktuję jak rzemiosło. Uważam, że powinien być testowany, dobrze zorganizowany, a także wspierany przejrzystą dokumentacją. Przestrzegam zasad SOLID i cenię prostotę, bo przejrzystość zawsze wygrywa ze skrótami. W pracy staram się automatyzować wszystko, co możliwe, aby zespoły mogły działać szybciej bez poświęcania jakości. Jednocześnie pozostaję ciekawy i pragmatyczny: eksploruję nowe narzędzia i podejścia, ale wdrażam je tylko wtedy, gdy wnoszą realną wartość do produktu i dla ludzi, którzy z niego korzystają.'
    },
    skills: {
      title: 'Umiejętności',
      subtitle: 'Praktyczna inżynieria zakorzeniona w Pythonie, napędzana automatyzacją i kierowana ciekawością.'
    },
    projects: {
