...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <Card className="group border-orange-200/50 bg-orange-50/50 transition-all duration-300 hover:scale-105 hover:bg-orange-100/50 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
