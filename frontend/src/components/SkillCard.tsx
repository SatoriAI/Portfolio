...
const SkillCard = ({ skill }: SkillCardProps) => {
  ...
  return (
    <Card className="bg-orange-50/50 dark:bg-white/5 border-orange-200/50 dark:border-white/10 hover:bg-orange-100/50 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105 group min-h-[280px] max-h-[320px] flex flex-col">
      <CardHeader className="text-center flex flex-col items-center justify-center flex-shrink-0">
        ...
        <Badge
          variant="secondary"
          className="bg-gradient-to-r from-orange-500/20 to-red-500/20 text-orange-700 border-orange-400/30 dark:from-blue-500/20 dark:to-teal-500/20 dark:text-blue-300 dark:border-blue-400/30 justify-center mt-2"
        >
          {skill.level}
        </Badge>
      </CardHeader>
