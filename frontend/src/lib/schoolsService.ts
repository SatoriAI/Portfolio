...
const mockSchools: ApiSchool[] = [
    {
        ...
        translations: {
            en: {
                ...
                research: "Algebraic Topology and Applications to Data Analysis - Developing novel computational methods for topological data analysis and persistent homology with applications in machine learning and data science.",
            ...
            pl: {
                ...
                research: "Topologia Algebraiczna i Zastosowania w Analizie Danych - Opracowywanie nowatorskich metod obliczeniowych dla topologicznej analizy danych i homologii trwałej z zastosowaniami w uczeniu maszynowym i nauce o danych.",
                advisor: "prof. Adam Nowak",
                areas: [
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                university: "Wrocław University of Technology",
                research: "Harmonic Analysis and Functional Analysis - Research focused on operator theory and spectral analysis with applications to signal processing.",
            ...
            pl: {
                ...
                university: "Politechnika Wrocławska", 
                research: "Analiza Harmoniczna i Analiza Funkcjonalna - Badania skupione na teorii operatorów i analizie spektralnej z zastosowaniami w przetwarzaniu sygnałów.",
                advisor: "prof. dr hab. Maria Kowalska",
                areas: [
                    "Analiza Harmoniczna",
