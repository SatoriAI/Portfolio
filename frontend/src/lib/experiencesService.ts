...
const mockExperiences: ApiExperience[] = [
    {
        ...
        translations: {
            ...
            pl: {
                location: "Zdalnie",
                description: "Kierowanie rozwojem skalowalnej architektury mikrousług obsługującej ponad 2 mln zapytań dziennie. Implementacja zaawansowanych potoków RAG do przetwarzania dokumentów i integracji LLM.",
                achievements: [
    ...
    },
    {
        ...
        translations: {
            ...
            pl: {
                location: "San Francisco, CA",
                description: "Rozwój i utrzymanie systemów backendowych dla potoków przetwarzania danych. Specjalizacja w budowaniu API i optymalizacji baz danych dla aplikacji o wysokiej przepustowości.",
                achievements: [
    ...
    },
    {
        ...
        translations: {
            ...
            pl: {
                location: "New York, NY",
                description: "Dołączenie do wczesnego startupu w celu budowy początkowego produktu od podstaw. Praca nad rozwojem frontendu i backendu przy jednoczesnym ustanowieniu praktyk developmentu.",
                achievements: [
