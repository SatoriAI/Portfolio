class VexChatTester {
    ...
    loadSettings() {
        ...
        const savedSessionId = localStorage.getItem('vex_chat_session_id');
        if (savedSessionId) {
    ...
    saveSettings() {
        ...
        if (this.sessionId) {
            localStorage.setItem('vex_chat_session_id', this.sessionId);
        }
    ...
    clearChat() {
        ...
        localStorage.removeItem('vex_chat_session_id');
    ...
    async sendPostMessage(message) {
        ...
        if (data.session_id) {
            ...
            this.sessionIdInput.value = data.session_id;
            localStorage.setItem('vex_chat_session_id', data.session_id);
        }
        ...
        console.log('POST message sent successfully, session:', data.session_id);
        return data;
    }
